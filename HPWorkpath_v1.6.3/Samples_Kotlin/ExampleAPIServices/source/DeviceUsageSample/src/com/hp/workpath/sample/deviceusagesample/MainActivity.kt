...
class MainActivity : AppCompatActivity() {
    private lateinit var mDeviceUsageFragment: DeviceUsageFragment
    private lateinit var mAlertDialog: AlertDialog

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main)
        mDeviceUsageFragment = DeviceUsageFragment()
    }
    ...
    fun handleComplete() {
        if (applicationContext != null) {
            ...
            Logger.showResult(this@MainActivity, getString(R.string.initialized))
        }
    }
    ...
    companion object {
        const val TAG = "[SAMPLE]" + "DeviceUsage"
    }
