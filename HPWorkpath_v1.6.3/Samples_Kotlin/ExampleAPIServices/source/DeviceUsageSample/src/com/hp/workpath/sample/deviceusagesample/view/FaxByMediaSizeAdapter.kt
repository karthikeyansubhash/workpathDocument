...
class FaxByMediaSizeAdapter : RecyclerView.Adapter<FaxByMediaSizeAdapter.ViewHolder>() {
    private var mFaxByMediaSizeList: List<PrinterInfo.FaxByMediaSize> = ArrayList()

    private fun getItem(position: Int): PrinterInfo.FaxByMediaSize {
        return mFaxByMediaSizeList[position]
    }

    fun setItem(byJobCategoryAndMediaSizes: List<PrinterInfo.FaxByMediaSize>) {
        mFaxByMediaSizeList = byJobCategoryAndMediaSizes
    ...
    override fun getItemCount(): Int {
        return mFaxByMediaSizeList.size
    }
