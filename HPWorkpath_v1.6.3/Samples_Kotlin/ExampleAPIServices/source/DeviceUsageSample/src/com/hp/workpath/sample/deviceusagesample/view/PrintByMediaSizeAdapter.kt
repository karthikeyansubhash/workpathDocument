...
class PrintByMediaSizeAdapter : RecyclerView.Adapter<PrintByMediaSizeAdapter.ViewHolder>() {
    private var mPrintByMediaSizeList: List<PrinterInfo.PrintByMediaSize> = ArrayList()

    private fun getItem(position: Int): PrinterInfo.PrintByMediaSize {
        return mPrintByMediaSizeList[position]
    }

    fun setItem(byJobCategoryAndMediaSizes: List<PrinterInfo.PrintByMediaSize>) {
        mPrintByMediaSizeList = byJobCategoryAndMediaSizes
