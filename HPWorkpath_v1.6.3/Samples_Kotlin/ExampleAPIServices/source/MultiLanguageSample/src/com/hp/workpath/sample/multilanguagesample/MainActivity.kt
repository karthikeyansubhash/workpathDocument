...
import com.hp.workpath.sample.multilanguagesample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun findViewElements() {
        mBindingActivityMain.messageButton.setOnClickListener { Toast.makeText(this@MainActivity, getString(R.string.message, "[Office]"), Toast.LENGTH_LONG).show() }
    }
