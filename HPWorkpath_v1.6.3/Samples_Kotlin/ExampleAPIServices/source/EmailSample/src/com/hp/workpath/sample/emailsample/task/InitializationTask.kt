            ...
            mContextRef.get()?.run {
                if (status == InitStatus.NO_ERROR) {
                    ...
                    when (status) {
                        ...
                        InitStatus.NOT_SUPPORTED -> handleException(Throwable(this.getString(R.string.service_not_supported)))
                        else -> handleException(Throwable(this.getString(R.string.unknown_error)))
                    }
                }
            }
        }
