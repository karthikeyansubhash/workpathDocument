...
import com.hp.workpath.sample.accessoryservicesample.databinding.ActivitySignInBinding
import com.hp.workpath.sample.accessoryservicesample.databinding.LayoutManualZoneBinding
        ...
        try {
            ...
            when (v) {
                ...
                mBindingActivitySignIn.failButton -> {
                    val failureMessage = "This is failure message from AccessoryService Sample."
