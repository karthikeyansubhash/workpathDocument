...
import com.hp.workpath.sample.accessoryagentsample.service.AccessoryAgentService.Companion.showLogResult
...
object ActionUtil {
    ...
    fun getAction(context: Context): SignInAction.Action {
        try {
            ...
            showLogResult("ConfigService.getDefaultConfig " + t.message)
        }
