...
public class AuthenticationActivity extends AppCompatActivity {
    ...
    public static final String TAG = "[SAMPLE]" + "AuthAgent";
    ...
    private final static String SCREEN_4_3_INCH = "Screen_4.3_Inch";
        ...
        public void onClick(View v) {
            ...
            try {
                ...
                if (v == mSignInButton) {
                    ...
                    String failureMessage = "This is failure message from AuthenticationAgent Sample.";
