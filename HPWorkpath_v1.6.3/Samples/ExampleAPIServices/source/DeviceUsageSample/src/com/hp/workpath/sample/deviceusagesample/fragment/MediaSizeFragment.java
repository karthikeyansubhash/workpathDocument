...
public class MediaSizeFragment extends Fragment {

    private MediaSizeAdapter mListAdapter;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_media_size, container, false);
        RecyclerView mListView = view.findViewById(R.id.mediaSizeView);
        mListAdapter = new MediaSizeAdapter();
    ...
    private void showJobCategoryAndMediaSize(String data) {
        Gson gson = new Gson();
        Type listType = new TypeToken<List<ScannerInfo.ByMediaSize>>() {
        }.getType();
        List<ScannerInfo.ByMediaSize> list = gson.fromJson(data, listType);
