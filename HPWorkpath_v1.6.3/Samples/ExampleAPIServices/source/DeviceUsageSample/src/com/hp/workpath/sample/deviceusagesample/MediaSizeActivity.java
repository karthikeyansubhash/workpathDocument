...
public class MediaSizeActivity extends AppCompatActivity {

    public static final String DATA = "data";

    private MediaSizeFragment mMediaSizeFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMediaSizeFragment = new MediaSizeFragment();
        mMediaSizeFragment.setArguments(bundle);
    }
