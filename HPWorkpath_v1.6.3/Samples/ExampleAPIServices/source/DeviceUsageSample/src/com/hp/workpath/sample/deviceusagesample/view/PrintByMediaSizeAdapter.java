...
public class PrintByMediaSizeAdapter extends RecyclerView.Adapter<PrintByMediaSizeAdapter.ViewHolder> {

    List<PrinterInfo.PrintByMediaSize> mPrintByMediaSizeList = new ArrayList<>();

    public PrinterInfo.PrintByMediaSize getItem(int position) {
        return mPrintByMediaSizeList.get(position);
    }

    public void setItem(List<PrinterInfo.PrintByMediaSize> printByMediaSizes) {
        mPrintByMediaSizeList = printByMediaSizes;
    ...
    public int getItemCount() {
        return mPrintByMediaSizeList.size();
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        PrinterInfo.PrintByMediaSize data = getItem(position);
