...
public class AuthenticationService extends AbstractAuthenticationService {
    ...
    private static final String TAG = AuthenticationActivity.TAG + "/S";
    ...
    protected void onPrePrompt() {
        try {
            if (initializedSDKQueue.take()) {
                ...
                AccessService.signIn(AuthenticationService.this, signInAction, getWindowsData(), result);
                if (result != null && result.getCode() != Result.RESULT_OK) {
                    ...
                    AccessService.signIn(AuthenticationService.this, failAction, null, null);
                }
            }
        } catch (Throwable t) {
    ...
    private void showLogResult(String msg, Result result) {
        if (result != null) {
            ...
            if (result.getCode() == Result.RESULT_FAIL) {
                Log.e(AuthenticationActivity.TAG, msg);
            } else {
                Log.d(AuthenticationActivity.TAG, msg);
            }
        } else {
            Log.d(AuthenticationActivity.TAG, msg);
        }
